...
Esse projeto está sendo produzido utilizando a **IDE IntelliJ** jutamente com **Spring Boot** 4.0.4.
As dependências utilizadas para os projetos são: 

- org.springframework.boot
  - starter-data-jpa
  - starter-webmvc
  - starter-data-jpa-test
  - starter-webmvc-test
  - maven-plugin
- com.h2database
